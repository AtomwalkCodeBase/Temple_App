...
const styles = StyleSheet.create({
  ...
  segment: {
    ...
    borderRadius: radius.pill, padding: 3, borderWidth: 1, borderColor: theme.skyChipBorder,
  },
  ...
  addButton: {
    ...
    backgroundColor: theme.accent, borderRadius: radius.m, paddingVertical: 10, marginBottom: 8,
  },
